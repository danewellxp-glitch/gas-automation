    ...
    switch (service.key) {
      ...
      case 'postgres':
        return (
          <div className="space-y-2">
            <div className="rounded-lg bg-gray-50 p-3">
              <div className="text-xs text-gray-500">Conexões ativas</div>
              <div className="text-lg font-semibold text-gray-900">
      ...
      case 'waha':
        ...
        return (
          <div className="space-y-2">
            <div className="rounded-lg bg-gray-50 p-3">
              <div className="text-xs text-gray-500">Status da sessão</div>
            ...
            {service.qr_code_base64 && (
              <div className="rounded-lg border border-gray-200 bg-white p-3">
                <div className="text-xs text-gray-500 mb-2">QR Code para conexão</div>
                <img 
      ...
      <div className="mb-4 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <div className="text-xs text-gray-500 capitalize">{service.key}</div>
          </div>
        </div>
    ...
    <div>
      <div className="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="text-gray-600">Status em tempo real dos serviços críticos</p>
        </div>
        <button
          onClick={fetchHealth}
          disabled={loading}
      ...
      {loading && !data ? (
        <div className="rounded-lg border border-gray-200 bg-white p-8 text-center shadow-sm">
          ...
          <p className="mt-3 text-sm text-gray-600">Carregando status...</p>
        </div>
      ) : (
        <>
          {/* Status geral */}
          <div className="mb-6 rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <div className="text-lg font-semibold text-gray-900">Status geral do sistema</div>
