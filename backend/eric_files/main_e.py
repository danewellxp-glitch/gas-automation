...
# Auth centralizado - importar todas as funções de autenticação daqui
from backend.auth import (
    get_session, get_current_user, get_current_active_user,
    hash_password, verify_password,
    create_access_token, create_refresh_token, validate_refresh_token,
    require_role, require_admin, require_owner, require_operador,
...
# Banco de dados importado de backend.config
print("Database engine loaded from backend.config")
...
# Autenticação importada de backend.auth (centralizado)
...
# get_db mantido para compatibilidade com alguns endpoints
def get_db():
    with Session(engine) as session:
        yield session

# Funções de auth importadas de backend.auth:
# - get_session, get_current_user, get_current_active_user
# - hash_password, verify_password
# - create_access_token, create_refresh_token, validate_refresh_token
# - require_role, require_admin, require_owner, require_operador
